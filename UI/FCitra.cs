...
{
	public partial class FCitra : Form
	{
		...
		public FCitra(CascadeClassifier haarFace)
		{
			InitializeComponent();
			haar = haarFace;
			nama();
		...
		private void FCitra_FormClosing(object sender, FormClosingEventArgs e)
		{ 
		...
		private void btnAddAll_Click(object sender, EventArgs e)
		{
            ...
            {
				MessageBox.Show("Silahkan pilih NPM Mahasiswa");
            } else
            {
		...
		private void nama()
        {
			...
			while (reader.Read())
			{
				textBox1.Items.Add(reader["npm"].ToString());
			}
			comm.Dispose();
		}

        private void FCitra_Load(object sender, EventArgs e)
        {
